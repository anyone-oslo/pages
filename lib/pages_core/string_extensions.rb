...
module PagesCore
  module StringExtensions
    ...
    def truncate(max_length, end_string='')
      warn "PagesCore::StringExtensions#truncate is deprecated"
      words = self.split(' ')
    ...
    # DEPRECATED: Remove this in 2.5
    def with_http
      warn "PagesCore::StringExtensions#with_http is deprecated"
    ...
    # DEPRECATED: Remove this in 2.5
    def without_http
      warn "PagesCore::StringExtensions#without_http is deprecated"
